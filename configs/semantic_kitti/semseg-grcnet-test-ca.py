...
weight = 'exp/semantic_kitti/grcnet-w2048-b02/model/model_best.pth'
param_dicts = [
    {"keyword": "CA", "lr": 0.24},  # 新添加层的学习率
    {"keyword": "", "lr": 0.0024}
]
...
model = dict(
    type="GRCSegmentor",
    backbone=dict(type="GRCNet", nclasses=19, if_ca=True, kl=[0.001, 0.001, 0.0001, 0.0001]),
    criteria=[
        dict(
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        transform=[
            dict(type="RandomDistanceDropout", dropout_ratio=1, mode='sigmoid', steepness=5, midpoint=0.3, maxdist=80, min_ratio=0.1),
